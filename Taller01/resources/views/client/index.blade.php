...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('client.create') }}" class="btn btn-outline-dark fw-bold">Register New Client</a>
    </div>
        ...
        <div class="col-md-4 col-lg-3 mb-4"> 
            <div class="card shadow-sm border-warning h-100"> 
                ...
                <div class="card-header bg-brand-black text-white text-center py-2">
                    <span class="fw-bold" style="letter-spacing: 1px;">CLIENT ID: {{ $client->getId() }}</span>
                </div>
